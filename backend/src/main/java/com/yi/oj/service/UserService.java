...
import com.yi.oj.model.dto.user.UserQueryRequest;
...
public interface UserService extends IService<User> {
     ...
     * @return 新用户 id
     */
    long userRegister(String userAccount, String userPassword, String checkPassword, String userEmail, String emailVerifyCode);
     ...
     * @return 脱敏后的用户信息
     */
    LoginUserVO userLogin(String userAccount, String userPassword, String userEmail, HttpServletRequest request);
