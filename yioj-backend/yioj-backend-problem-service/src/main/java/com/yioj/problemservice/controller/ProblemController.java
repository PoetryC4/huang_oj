package com.yioj.problemservice.controller;
...
import com.yioj.model.model.dto.problem.*;
...
public class ProblemController {
    ...
    public BaseResponse<Boolean> deleteProblem(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!problem.getUserId().equals(user.getId()) && !userFeignClient.isAdmin(request)) {
