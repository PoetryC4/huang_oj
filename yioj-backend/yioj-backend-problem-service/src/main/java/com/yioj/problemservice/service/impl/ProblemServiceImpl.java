...
import com.yioj.model.model.entity.*;
...
import com.yioj.problemservice.mapper.ProblemMapper;
...
public class ProblemServiceImpl extends ServiceImpl<ProblemMapper, Problem>
    ...
    public ProblemVO getProblemVO(Problem problem, HttpServletRequest request) {
        ...
        if (loginUser == null || loginUser.getId() == null) {
            ...
            long count1 = submissionFeignClient.count(queryWrapper1);
            queryWrapper1.eq("judgeStatus", SubmissionResultEnum.ACCEPT.getValue());
            long count2 = submissionFeignClient.count(queryWrapper1);
            if (count2 > 0) {
